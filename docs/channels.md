...
保存后，口袋龙虾会自动通过 WebSocket 连接飞书。口袋龙虾已自动设置为"开放模式"（dmPolicy=open），任何人给机器人发消息都可以直接收到 AI 回复，无需手动配对审批。
...
- iOS 微信 8.0.70 或更高版本（Android 最新版也已支持）
- 中国大陆网络
...
配对完成后，在微信中给你的 ClawBot 发消息即可收到 AI 回复。

### 注意事项

- 24 小时消息窗口：超过 24 小时未互动，需要用户重新发起对话
- 这是腾讯官方功能，不是第三方协议，不会被封号
- 二维码有效期约 2 分钟，过期后点击"重新生成"即可
- 如需更换微信账号，点击"重新登录"重新扫码
